...
function Ajax_test2(getId_) {
    ...
    if (document.getElementById("L1_todolist1_id"+getId_)) {
	    var LBTN_tanstt1 = document.getElementById("L1_todolist1_id"+getId_);
        LBTN_tanstt1.id = "todolist1_id"+getId_;
	    LBTN_td2frameid.append(LBTN_tanstt1);
    } else if (document.getElementById("L2_todolist1_id"+getId_)) {
	    var LBTN_tanstt2 = document.getElementById("L2_todolist1_id"+getId_);
        LBTN_tanstt2.id = "L1_todolist1_id"+getId_;	
...
var tanstt = document.getElementById("todolist1_id"+getIdNum);
//tanstt.style.height = 170 + "px";
td2frameid.append(tanstt);
            } else {
                console.error(xhr_Ajax_test3.responseText);
            }
        }
...
function Ajax_test6(getIdNum6) {
	
    var td2frameid = document.getElementById("todolist2_frame_id");
    var td3frameid = document.getElementById("todolist3_frame_id");
    
    //var tanstt1 = document.getElementById("todolist1_id"+getIdNum6);

    if (document.getElementById("todolist1_id"+getIdNum6)) {
	    var tanstt1 = document.getElementById("todolist1_id"+getIdNum6);
        tanstt1.id = "L1_todolist1_id"+getIdNum6;
	    td2frameid.append(tanstt1);
    } else if (document.getElementById("L1_todolist1_id"+getIdNum6)) {
	    var tanstt2 = document.getElementById("L1_todolist1_id"+getIdNum6);
        tanstt2.id = "L2_todolist1_id"+getIdNum6;	
...
function Ajax_test7(getIdNum7) {
    var td3frameid = document.getElementById("todolist3_frame_id");
    var tanstt2 = document.getElementById("todolist1_id"+getIdNum7);
    td3frameid.append(tanstt2);
}
